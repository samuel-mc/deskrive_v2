<section class="max-w-7xl mx-auto py-0 px-2" id="diseñoSection">
    <div class="grid place-items-center place-content-center px-4">
        ...
        <div class="col-start-1 row-start-1 p-4 text-center">
            ...
            <h4 class="text--h4 mb-2">Diseño de sitio web en tiempo real</h4>
            <p class="mx-auto max-w-sm text--p">HOLA ipsum dolor sit amet, consectetur adipiscing elit. Maecenas nec tempor massa. Aliquam interdum, velit et accumsan dapibus, orci mauris sagittis neque, ac tempor justo est in diam. Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
        </div>
    </div>
</section>